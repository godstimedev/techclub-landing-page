      ...
      <nav className="max-w-[1240px] mx-auto h-[100%] px-4 flex justify-between items-center ">
        ...
        <ul className=" hidden md:flex md:items-center">
          <Link to="registration">
            <button className=" py-3 px-6  bg-[#78B8A4] hover:opacity-80 focus:ring-[#333] focus:ring-offset-[#78B8A4] text-[#fff]  mx-auto transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg">
              Register
            </button>
          </Link>
        </ul>
